        ...
        <a-row :gutter="16">
          ...
          <a-col v-bind="colLayout">
            <a-form-item label="所属分类" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-select v-model="queryParam.categorys" allowClear mode="multiple" showSearch option-filter-prop="children">
                <a-select-option :value="value.number" v-for="value in allCategory" :key="value.id">{{ value.name }}</a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
          <a-col v-bind="colLayout">
