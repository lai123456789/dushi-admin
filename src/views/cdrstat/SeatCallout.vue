  ...
  <a-spin :spinning="loading">
    ...
    >
      ...
      <s-table
        ...
        slot-scope="text"
        v-if="expandKey === text.extension && currentKey === 'callOut'"
        size="small"
        rowKey="row"
