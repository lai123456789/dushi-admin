...
<template>
  <div>
    <div v-if="!formConfig.tableType">
      ...
      >
        <a-input v-if="record.formtype === 'text' && record.type !=='place'" :disabled="record.fieldrule === 'readonly'" :placeholder="record.placeholder !== '0' ? record.placeholder : '单行文本'">
        ...
        <a-input v-else-if="record.type === 'workRemark'" placeholder="流程办理备注"><a-icon slot="suffix" type="align-left" /></a-input>
        ...
        <a-input v-else-if="record.formtype === 'textarea'" :rows="2" :disabled="record.fieldrule === 'readonly'" placeholder="多行文本"><a-icon slot="suffix" type="align-left" /></a-input>
        ...
        <div v-else-if="record.formtype === 'tag'"><a-tag>500元以下</a-tag><a-icon type="tags" /></div>
        ...
        <a-input
          ...
          placeholder="图片"
        ><a-icon slot="suffix" type="picture" /></a-input>
        <a-input
