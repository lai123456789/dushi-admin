<template>
  ...
  >
    <a-spin :spinning="loading">
      <a-form :form="form">
        <a-form-item label="联动数据表" :wrapperCol="wrapperCol">
          <a-cascader
        ...
        <a-form-item validate-status="success" label="数据联动" :wrapperCol="wrapperCol">
          <a-select
          ...
          <a-select
            ...
            style="width: 200px; margin: 0 10px 0 24px;">
          ...
          <a-select
            ...
            style="width: 200px; margin-right: 10px;">
            <a-select-option value="key">当前子表单名称</a-select-option>
          </a-select>联动显示
          <a-select
            placeholder="请选择源数据表关联字段"
            show-search
